...
for num in range(num_start,num_start+num_interval):    
...
ani.save("./orbit_gif/"+mode_out+"_exp"+str(exp)+"_"+str(exp_num)+"_"+str(num_start)+"-"+str(num_start+num_interval-1)+".gif", writer="imagemagick")
#sys.exit()
